...
export const acceptRideRequest = async (req, res) => {
  ...
  try {
    ...
    const estimatedFare = parseFloat(request.estimated_total);

    // 2️⃣ Fetch default payment method
