...
export class SettlementService {
  ...
  // ==========================================================
  // CREATE SETTLEMENT RECORD (after ride completion)
  // ==========================================================
  ...
  static async createSettlement({
    ...
    return await withTransaction(async (client) => {
      ...
      const payment = await RidePayment.findById(paymentId, client);
      ...
      if (existing) {
        throw new AppError("SETTLEMENT_ALREADY_EXISTS", 409);
      }
      ...
      const settlement = await Settlement.create({
        ...
        settlement_ledger_entry: ledgerEntryId,
  ...
  // ==========================================================
  // MARK SETTLEMENT AS PROCESSING (payout initiated)
  // ==========================================================

  static async markProcessing(settlementId) {
    ...
    return await withTransaction(async (client) => {
      ...
      if (settlement.status !== "pending") {
        throw new AppError("INVALID_SETTLEMENT_STATE", 400);
      }
  ...
  // ==========================================================
  // COMPLETE SETTLEMENT (bank transfer success)
  // ==========================================================

  static async completeSettlement(settlementId) {
  ...
  static async failSettlement(settlementId, reason) {
  ...
  // ==========================================================
  // GET PENDING SETTLEMENTS (for payout workers)
  // ==========================================================
