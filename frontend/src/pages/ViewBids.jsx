...
// import { DollarSign, Star, Clock, Car, Check, X } from 'lucide-react';

// const ViewBids = ({ auth, setView }) => {
...
//     // Listen for new bids via Socket.IO
//     const handleNewBid = (bidData) => {
//       setBids(prev => [bidData, ...prev]);
//     };
    
//     // socket.on('ride:bid:new', handleNewBid);
//     // return () => socket.off('ride:bid:new', handleNewBid);
//   }, []);
...
//                 border: bid.status === 'pending' ? '2px solid rgba(16, 185, 129, 0.3)' : undefined
//               }}>
//                 {/* Driver Info */}
...
//                   <span className="text-dim">• {bid.vehicle_color}</span>
//                   <span className="text-dim">• {bid.license_plate}</span>
//                 </div>
